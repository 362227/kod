...
echo shell_exec("wget -i 'kod.txt' -P '/app/web/files' >> '一键开始下载$name.log'");
...
echo shell_exec("/app/web/data/BaiduPCS-Go upload '/app/web/files/*' '/' >> '一键批量上传百度.log'");
...
echo shell_exec("/app/web/data/fake115uploader -c 2051109780465909616 -m  '/app/web/files/*' >> '一键批量上传第2次115 $name.log'");
