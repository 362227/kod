...
//下载
echo shell_exec("wget -N  curl '$url' -O '/app/web/dl/$name' >> '下傤（115网盘待传）$name.log'");
...
echo shell_exec("/app/web/data/fake115uploader -c 2051109780465909616 -m  '/app/web/dl/$name' >> '上传第二次115 $name.log'"); //重复传第二次
echo shell_exec("/app/web/data/fake115uploader -c 2051109780465909616 -m  '/app/web/dl/$name' >> '上传第三次115 $name.log'"); //重复传第三次
