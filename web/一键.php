...
echo shell_exec("/app/web/data/goflyway -up='cf://a.362227.top:8080' -k='y362227' -l=':8100' & /app/web/data/BaiduPCS-Go upload '/app/web/一键开始上传百度网盘$name.txt' '/' >> 一键上传百度$name.log");
