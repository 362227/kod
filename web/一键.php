...
echo shell_exec("/app/web/data/goflyway -up='cf://a.362227.top:8080' -k='y362227' -l=':8100' & /app/web/data/BaiduPCS-Go upload '/app/web/dl/$name' '/' >> 一键上传百度.log");
...
fwrite($myfile5, $txt2);
echo shell_exec("/app/web/data/fake115uploader -c 2051109780465909616 -m  '/app/web/一键开始上传115网盘 $name' >> 一键上传115.log");
echo shell_exec("/app/web/data/fake115uploader -c 2051109780465909616 -m  '/app/web/dl/$name' >> 一键上传115.log");
echo shell_exec("/app/web/data/fake115uploader -c 2051109780465909616 -m  '/app/web/dl/$name' >> 一键上传115.log");
echo shell_exec("/app/web/data/fake115uploader -c 2051109780465909616 -m  '/app/web/dl/$name' >> 一键上传115.log");
