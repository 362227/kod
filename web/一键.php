...
echo shell_exec("/app/web/data/goflyway -up='cf://a.362227.top:8080' -k='y362227' -l=':8100' & /app/web/data/BaiduPCS-Go upload '/app/web/一键开始上传百度网盘 $name' '/'");
...
fwrite($myfile5, $txt);
echo shell_exec("/app/web/data/fake115uploader -c 2051109780465909616 -m  '/app/web/一键开始上传115网盘 $name' >> 115.log");
