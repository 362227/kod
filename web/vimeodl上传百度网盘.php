...
echo shell_exec("/app/web/data/BaiduPCS-Go config set -max_upload_parallel 32");
...
echo shell_exec("/app/web/data/BaiduPCS-Go config set -pcs_addr c4.pcs.baidu.com");
echo shell_exec("/app/web/data/BaiduPCS-Go upload /app/web/vimeodl/* /files --retry 14 > /app/web/vimeodl上传百度网盘.txt");
