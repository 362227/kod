...
//echo date('Y-m-d H:i:s');
	...
	//       echo shell_exec("rclone  copy '/app/web/dl/' ysf20202:vimeo --transfers=1 -P --stats-one-line --contimeout 5h --max-depth 1 --size-only --max-age 45m --min-size 130M >> 'vimeo上传谷歌网盘.log'");
	    }else{
	    	echo "不在区间内";
	    }
    }
