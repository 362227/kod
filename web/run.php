...
echo shell_exec("/app/web/data/rclone  move '/app/web/dl/' ysf2020:vimeo --transfers=2 -P --stats-one-line --contimeout 5h --max-depth 1 --size-only --exclude *.{bak,txt,oexe,html,php}  --min-age 600m --min-size 130M >> 'vimeo上传谷歌网盘.log'");
