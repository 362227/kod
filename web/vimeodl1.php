...
<p><button id="btn1" class="blue button"  onclick="window.location.href='vimeodl1.php'">提交</button></p>
...
$url = str_replace(array('http://vimeo.com','https://vimeo.com'), array('https://362227.top/rss/vimeo10362227.php?id=http://vimeo.com','https://362227.top/rss/vimeo10362227.php?id=http://vimeo.com'), $url);
...
$linkstxt = preg_replace('/(^http|^youtube|^vimeo|^www)([\s\S]{8,45}).*/','$1$2', $links); //取url前8-45个作为超链名字
$linkslink = preg_replace('/((^http|^youtube|^vimeo|^www).*)/','$1', $links); //取url完整
...
shell_exec("rm -rf /app/web/vimeodl1cmd.txt"); //删除临时文件
