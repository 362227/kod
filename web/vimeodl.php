...
<p><button id="btn1" class="blue button"  onclick="window.location.href='vimeodl.php'">提交</button></p>
...
if ($renamelenth>1) {
    echo shell_exec("cd /app/web/vimeodl/ && /app/web/data/yt-dlp -a /app/web/vimeodlurl.txt -o '$rename' --no-mtime > /app/web/vimeodl下载日志.txt 2>&1");}
        ...
        echo shell_exec("cd /app/web/vimeodl/ && /app/web/data/yt-dlp -a /app/web/vimeodlurl.txt --no-mtime > /app/web/vimeodl下载日志.txt 2>&1");}
